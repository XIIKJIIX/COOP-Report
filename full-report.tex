...
\newcommand{\ThesisTiTleENG}{*********}
\newcommand{\ThesisTiTleENGSnakecase}{*********}
%Your name
...
\newcommand{\Exami}{*********}
%สถานประกอบการ
\newcommand{\Company}{SEC Consult (Thailand) Co., Ltd.}
...
\newcommand{\SubD}{*********}
%วันเริ่มทำงาน
\newcommand{\StartDWork}{*********}
%วันสุดท้ายของการทำงาน
\newcommand{\EndDWork}{*********}
%ที่อยู่สถานประกอบการ
\newcommand{\Address}{29/1 Phloen Chit Rd, Khwaeng Lumphini, Khet Pathum Wan, Krung Thep Maha Nakhon 10330}
%เว็บไซต์สถานประกอบการ
\newcommand{\Website}{sec-consult.com/en/}
%ตำแหน่งานที่ปฏิบัติ
\newcommand{\Position}{นักทดสอบเจาะระบบ}
