...
\newcommand{\ThesisTiTle}{รายงานสรุปช่องโหว่ของเว็บแอปพลิเคชันตามหมวดหมู่ของ OWASP Top 10}
%Your thesis title (ENG)
\newcommand{\ThesisTiTleENG}{WEB APPLICATION VULNERABILITIES GROUP BY OWASP TOP 10 REPORT}
\newcommand{\ThesisTiTleENGSnakecase}{Web Application Vulnerabilities Group by OWASP Top 10 Report}
%Your name
...
%วันส่งรายงาน
\newcommand{\SubD}{\textcolor{red}{วันส่งรายงาน}}
%วันเริ่มทำงาน
